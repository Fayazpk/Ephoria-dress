...
# Gemfile (at the top with other main gems)
gem 'omniauth', '~> 2.1', '>= 2.1.2', require: true
gem "omniauth-google-oauth2", require: true
#gem 'omniauth-rails_csrf_protection', require: true
